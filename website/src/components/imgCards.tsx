export default function ImgCards() {
    return (
        <div className="relative w-full h-screen mt-4 lg:mt-0 grid grid-col-10 lg:-ml-8">
            <div className="flex w-[320px] h-[55%] flex-col gap-3 rounded-2xl border duration-300 bg-center
            ...
            <div className="flex w-[420px] h-[70%] flex-col gap-3 rounded-2xl border duration-300 bg-center
                hover:-skew-x-3 hover:scale-105 hover:shadow-[2rem_2rem_2rem_-1rem_#0004,inset_1rem_1rem_4rem_-1rem_#fff1]
                border-zinc-800 bg-zinc-900 drop-shadow-[0_0_15px_rgba(49,49,49,0.35)] hover:border-zinc-600
