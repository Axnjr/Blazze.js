...
export const safe = (...args) => chalk.bold.greenBright(...args);

export const danger = (...args) => chalk.bold.redBright(...args);

export const infoGreyDev = (...args) => {
  if (process.env.devEnviroment == 'true') { console.log(chalk.gray(...args)); }
};
